          ...
          <div className="hero__inner">
            <div className="hero__copy">
              ...
              <div className="hero__socials fade-up delay-5" style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
                <a href="https://github.com/Rajneeshsharma125" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
                ...
                <a href="https://www.linkedin.com/in/rajneesh-sharma-12rh" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
